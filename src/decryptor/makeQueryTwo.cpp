...
int main(int argc, char *argv[]){
  ...
  table_size_out = pow(2,bit_num*3);
  ...
  cout<<"x[row,col]=["<<index_row_x<<", "<<index_col_x<<"],"
      <<"y[row,col]=["<<index_row_y<<", "<<index_col_y<<"]"<<endl;
  ...
  if(n_query==1){
    ...
    int64_t index = (index_row_x * row_size + index_col_x) * table_size_in
                     + (index_row_y * row_size + index_col_y);
