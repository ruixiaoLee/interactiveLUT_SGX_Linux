...
int main(int argc, char *argv[]){
  ...
  vector<vector<int64_t>> vectorOfInLUT1 = read_table("../Table/two/vectorOfInLUT_two_"+bit_num_str+".txt", slot_count);
  ...
  // //Read InputTable from file
  // vector<vector<int64_t>> vectorOfInLUT2 = read_table("../Table/two/vectorOfInLUT_two_"+bit_num_str+".txt", slot_count);
